...
{ 
    ...
    public class XmlSerializer : SerializerBase
    {
        ...
        public static XmlDocument Serialize(object obj, int version, string rootName)
        {
            ...
            //system types
            serializer.AddSurrogate(typeof(KeyValuePair<,>), new KeyValuePairSurrogate());
            serializer.AddSurrogate(typeof(Delegate), new DelegateSurrogate());
            
            //unity core types
            serializer.AddSurrogate(typeof(UnityEngine.Object), new UnityEngineObjectSurrogate());
            serializer.AddSurrogate(typeof(GameObject), new GameObjectSurrogate());
            serializer.AddSurrogate(typeof(Component), new ComponentSurrogate());
            
            //unity built-in components and types
            serializer.AddSurrogate(typeof(Transform), new TransformSurrogate());
            serializer.AddSurrogate(typeof(RectTransform), new RectTransformSurrogate());
            serializer.AddSurrogate(typeof(Renderer), new RendererSurrogate());
            serializer.AddSurrogate(typeof(Collider2D), new Collider2DSurrogate());

            //monobehaviours
            serializer.AddSurrogate(typeof(MonoBehaviour), new MonoBehaviourSurrogate());
