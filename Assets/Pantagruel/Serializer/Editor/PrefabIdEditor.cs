...
namespace Pantagruel.Serializer.Editor
{
    ...
    public class PrefabIdEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.TextArea("The 'Manifest Id' below is currently unused but future version will allow it to track " +
                "the name of the object should it change and update the manifest library accordingly.", GUILayout.Height(60));
            EditorGUILayout.Space();

            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Manifest Id", GUILayout.MaxWidth(80));
